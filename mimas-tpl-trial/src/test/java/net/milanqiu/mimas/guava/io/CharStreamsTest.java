...
public class CharStreamsTest {
    ...
    public void test_copy() throws Exception {
        ...
        Assert.assertEquals(ALL_CHAR_VALUES_COUNT, CharStreams.copy(r, a));
    ...
    public void test_skipFully() throws Exception {
        ...
        Assert.assertEquals(String.valueOf(ALL_CHAR_VALUES, 100, ALL_CHAR_VALUES_COUNT-100), CharStreams.toString(r));
    }
