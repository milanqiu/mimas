...
public class DoubleMathTest {
    ...
    public void test_fuzzyEquals() throws Exception {
        ...
        Assert.assertTrue(DoubleMath.fuzzyEquals(1.0/9, 0.11111111111111, LangUtils.PARTICLE_DOUBLE));
    }

    @Test
    public void test_fuzzyCompare() throws Exception {
        Assert.assertEquals(0, DoubleMath.fuzzyCompare(1.0 / 9, 0.11111111111111, LangUtils.PARTICLE_DOUBLE));
    }

    @Test
    public void test_mean() throws Exception {
        Assert.assertEquals(5.125, DoubleMath.mean(1, 2, 3, 4, 5, 6, 9, 11), LangUtils.PARTICLE_DOUBLE);
    }
}
