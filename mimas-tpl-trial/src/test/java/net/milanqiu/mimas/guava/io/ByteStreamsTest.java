...
public class ByteStreamsTest {
    ...
    public void test_copy() throws Exception {
        ...
        Assert.assertEquals(ALL_BYTE_VALUES_COUNT, ByteStreams.copy(is, os));
    ...
    public void test_skipFully() throws Exception {
        ...
        Assert.assertArrayEquals(Arrays.copyOfRange(ALL_BYTE_VALUES, 100, ALL_BYTE_VALUES_COUNT), ByteStreams.toByteArray(is));
    }
