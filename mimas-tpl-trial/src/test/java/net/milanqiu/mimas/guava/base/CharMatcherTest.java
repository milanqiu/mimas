...
public class CharMatcherTest {
    ...
    public void test_ANY() throws Exception {
        ...
        Assert.assertEquals(LangUtils.CHAR_VALUE_COUNT, charSet.size());
        for (int i = Character.MIN_VALUE; i <= Character.MAX_VALUE; i++) {
            Assert.assertTrue(charSet.contains((char) i));
        }
    }
    ...
    public void test_WHITESPACE() throws Exception {
        ...
        */
        ...
        MimasTplTrialConvention.getSingleton().writeWorkFileInTestOutDir(charAsciis);
    }
   ...
   public void test_is() throws Exception {
    ...
    public void test_isNot() throws Exception {
        ...
        Assert.assertEquals(LangUtils.CHAR_VALUE_COUNT-1, charSet.size());
        for (int i = Character.MIN_VALUE; i <= Character.MAX_VALUE; i++) {
            char ch = (char) i;
            if (ch == 'a')
    ...
    public void test_noneOf() throws Exception {
        ...
        Assert.assertEquals(LangUtils.CHAR_VALUE_COUNT-7, charSet.size());
        for (int i = Character.MIN_VALUE; i <= Character.MAX_VALUE; i++) {
            char ch = (char) i;
