 ...
 */
    ...
    public void test_index() throws Exception {
        ...
        Assert.assertTrue(CollectionUtils.equals(result.get(INT_0),
                ImmutableList.of(entity0, entity3, entity5)));
        Assert.assertTrue(CollectionUtils.equals(result.get(INT_1),
                ImmutableList.of(entity1)));
        Assert.assertTrue(CollectionUtils.equals(result.get(INT_2),
    ...
    public void test_filterKeys() throws Exception {
        ...
        Assert.assertTrue(CollectionUtils.equals(filtered.get(INT_0),
                ImmutableList.of(STR_3, STR_4)));
        Assert.assertTrue(CollectionUtils.equals(filtered.get(INT_2),
    ...
    public void test_filterValues() throws Exception {
        ...
        Assert.assertTrue(CollectionUtils.equals(filtered.get(INT_3),
                ImmutableSet.of(STR_2, STR_4)));
    }
