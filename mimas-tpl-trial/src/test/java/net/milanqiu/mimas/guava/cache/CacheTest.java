...
public class CacheTest {
    ...
    public void test_stats() throws Exception {
        ...
        Assert.assertEquals(1.0/3, stats.hitRate(), LangUtils.PARTICLE_DOUBLE);
        Assert.assertEquals(2,     stats.missCount());
        Assert.assertEquals(2.0/3, stats.missRate(), LangUtils.PARTICLE_DOUBLE);
        ...
        Assert.assertEquals(0.0,   stats.loadExceptionRate(), LangUtils.PARTICLE_DOUBLE);
        stats.totalLoadTime();
